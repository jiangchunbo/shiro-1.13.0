 ...
 *
 * 这是一个抽象类，是一个拦截器，用于拦截方法，校验一些特定的注解。此外，还有一些小拦截器，被当前类持有，
 *
 * @since 0.9
 */
public abstract class AuthorizingMethodInterceptor extends MethodInterceptorSupport {
     ...
     * <p>
     * 实现 invoke，这是一种 Before Advice，Before 的逻辑是校验是否有权限
     */
    @Override
    public Object invoke(MethodInvocation methodInvocation) throws Throwable {
        // 感觉 Shiro 对于 AOP 设计也挺迷惑的
        // 在 AuthorizingAnnotationMethodInterceptor 这个类也有类似的逻辑，但是他们的 assertAuthorized 不同
